...
static struct clk_lookup da850_clks[] = {
	...
	CLK("da8xx_lcdc_lidd.0",	"fck",		&lcdc_clk),
...
static const struct mux_config da850_pins[] = {
		...
		/* Pins from nand_flash.pins */
		MUX_CFG(DA850,	EMA_OE,	7,	20,	15,	1,	false)
		MUX_CFG(DA850,	EMA_CS_3,	7,	4,	15,	1,	false)
		MUX_CFG(DA850,	EMA_A_2,	12,	20,	15,	1,	false)
		MUX_CFG(DA850,	EMA_A_1,	12,	24,	15,	1,	false)
		MUX_CFG(DA850,	EMA_WE,	7,	16,	15,	1,	false)
		...
		/* Pins from uart.pins */
		MUX_CFG(DA850,	UART1_RTS,	0,	16,	15,	4,	false)
		MUX_CFG(DA850,	UART1_CTS,	0,	20,	15,	4,	false)
		MUX_CFG(DA850,	UART1_RXD,	4,	24,	15,	2,	false)
		MUX_CFG(DA850,	UART1_TXD,	4,	28,	15,	2,	false)
		MUX_CFG(DA850,	UART2_TXD,	4,	20,	15,	2,	false)
		/* Pins from unused.pins */
